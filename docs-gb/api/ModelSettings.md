...
| `parallel_workers` | `int \| None` | `None` | Use the `parallel_workers` field in the server-wide settings instead. |
| `parameters` | `ModelParameters \| None` | `None` | Extra parameters for each instance of this model. |
